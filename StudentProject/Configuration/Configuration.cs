...
namespace StudentProject.Configuration;
...
public static class Configure
{
    ...
    {
        services.AddDbContext<StudentContext>().AddIdentity<UserEntity, UserRole>(options =>
        {
    ...
    public static async void AddUsers(this WebApplication app)
    {
        using (var scope = app.Services.CreateScope())
        {
            ...
            var find = await userManager.FindByEmailAsync("tomasz.chmielarczyk@microsoft.wsei.edu.pl");
            if (find == null)
            {
                UserEntity user = new UserEntity {Email = "tomasz.chmielarczyk@microsoft.wsei.edu.pl", UserName = "Tomek"};
