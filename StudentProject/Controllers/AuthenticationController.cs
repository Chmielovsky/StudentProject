...
namespace Studenci2.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        private string CreateToken(UserEntity user)
        {
            return new JwtBuilder().WithAlgorithm(new HMACSHA256Algorithm())
                ...
                .AddClaim(JwtRegisteredClaimNames.Name, user.UserName).AddClaim(JwtRegisteredClaimNames.Gender, "male")
                ...
                .AddClaim(JwtRegisteredClaimNames.Jti, Guid.NewGuid()).Audience(_jwtSettings.Audience)
                .Issuer(_jwtSettings.Issuer).Encode();
        }
    }
}